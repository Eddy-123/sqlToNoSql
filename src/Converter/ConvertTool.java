...
import javax.swing.JButton;
	...
	public class ConvertTool  extends javax.swing.JFrame {

	    /**
	     * Creates new form ConvertTool 
	     */
	    public ConvertTool () {
	        initComponents();
	    }
	    ...
	    private void initComponents() {
	        ...
	        jsonText = new javax.swing.JTextArea();
	        ...
	        jButton1.addActionListener(new java.awt.event.ActionListener() {
	            public void actionPerformed(java.awt.event.ActionEvent evt) {
	                // TABLE LA PLUS UTILISEE: jTextField1
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(ConvertTool .class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new ConvertTool ().setVisible(true);
	            }
	        });
	    }

	    // Variables declaration - do not modify//GEN-BEGIN:variables
	    private javax.swing.JTextArea jsonText;
